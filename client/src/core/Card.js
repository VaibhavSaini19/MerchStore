	...
	return (
		<div className="card border">
			...
			<div className="card-body">
				...
				<button className="btn btn-success rounded btn-sm px-4 mr-1" style={{cursor: 'default'}}>$ {cardPrice}</button>
				<button disabled className="btn btn-danger rounded btn-sm px-4" style={{textDecoration: 'line-through', cursor: 'default'}}>$ {cardPrice*1.5}</button>
